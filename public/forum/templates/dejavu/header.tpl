...
{ELSE}
  <link rel="stylesheet" type="text/css" href="/stylesheets/core.css" media="screen"/>
  ...
  google.setOnLoadCallback(function() {
    $(document).ready(function(){
      if($("body").height() < $(window).height()){
        $("#footer").css("padding-top",$(window).height() - $("body").height() + 20);
      }
    });
  });
</script>
...
<body onload="{IF FOCUS_TO_ID}var focuselt=document.getElementById('{FOCUS_TO_ID}'); if (focuselt) focuselt.focus();{/IF}">
  ...
  <div id="ev_bg">
    <div id="everything">
      <div id="header">
        <h1><a href="/">Deja Vu - World of Warcraft Guild</a></h1>
      </div>
      <div id="middle">
        <div id="left_column">
          <div id="navigation">
          	<a href="/recruitment">Recruitment Application</a>
          	<a href="/news">News</a>
