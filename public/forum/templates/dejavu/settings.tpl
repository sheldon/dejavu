...
{VAR highlight_background_color "transparent"} {! -- should compliment the two above -- }
{VAR border_color "#4d894d"}
{VAR border_font_color "White"}
{VAR quote_border_color "#808080"}
{VAR pre_border_color "#C4C6A2"}
{VAR pre_background_color "transparent"}
{VAR link_color "#F9ECBF"}
{VAR link_hover_color "#f7a850"}
{VAR new_color "red"}
{VAR logo_background_color "transparent"}
{VAR breadcrumb_border_color "#b6b6b6"}
{VAR post_moderation_background_color "transparent"}
{VAR information_border_color "#62a762"}
{VAR information_background_color "transparent"}
{VAR warning_border_color "#A76262"}
{VAR warning_background_color "transparent"}
{VAR span_addition_background_color "transparent"}
{VAR span_addition_font_color "#000000"}
{VAR span_removal_background_color "transparent"}
{VAR span_removal_font_color "#000000"}
{VAR message_background_color "transparent"}
